...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0 width="100%"
 ...
 <tr>
  ...
  Rekomendasi Teknis Perpanjangan Rencana Pengoperasian Kapal Angkutan Penyeberangan Sementara {{$permohonan->formulir['Nama Kapal']}}</span></p>
  </td>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0 width="100%"
 ...
 <tr>
  ...
  <td width="44%" valign=top style='width:44.4%;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='text-align:justify'><span style='font-family:"Arial",sans-serif'>{{$permohonan->formulir['Nama Pemilik Kapal']}}</span></p>
  </td>
 </tr>
 <tr>
  <td width="15%" valign=top style='width:15.84%;padding:0in 5.4pt 0in 5.4pt'>
  ...
  <td width="44%" valign=top style='width:44.4%;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='text-align:justify'><span style='font-family:"Arial",sans-serif'>{{$permohonan->formulir['Lintas']}}</span></p>
  </td>
 </tr>
 <tr>
  <td width="15%" valign=top style='width:15.84%;padding:0in 5.4pt 0in 5.4pt'>
  ...
  <td width="44%" valign=top style='width:44.4%;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='text-align:justify'><span style='font-family:"Arial",sans-serif'>{{$permohonan->formulir['Nomor Izin Usaha Angkutan Penyeberangan (SIUAP)']}}</span></p>
  </td>
 </tr>
</table>
