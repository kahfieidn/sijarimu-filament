    ...
    <table class="c39">
        <tr class="c75">
            ...
            <td class="c85" colspan="1" rowspan="1">
                <p class="c80"><span class="c1">@if (isset($permohonan->formulir['Menimbang'])){{$permohonan->formulir['Menimbang']}}@endif</span></p>
            </td>
        </tr>
    </table>
    <p class="c19"><span class="c17"></span></p>
    ...
    <table class="c74">
        <tr class="c22">
            <td class="c0" colspan="1" rowspan="1">
                <p class="c28"><span class="c1">Tanjungpinang, @if(isset($permohonan->tanggal_izin_terbit)){{ \Carbon\Carbon::parse($permohonan->tanggal_izin_terbit)->isoFormat('D MMMM Y') }}@else [DRAFT] @endif</span></p>
            </td>
        </tr>
        <tr class="c22">
            <td class="c0" colspan="1" rowspan="1">
