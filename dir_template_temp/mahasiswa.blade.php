...
<body class="c12 doc-content">
    ...
    <table class="c39">
        ...
        <tr class="c14">
            ...
            <td class="c7" colspan="1" rowspan="1">
                <p class="c15"><span class="c1">Peraturan Daerah Provinsi Kepulauan Riau Nomor 7 Tahun 2016 tentang Pembentukan dan Susunan Perangkat Daerah Provinsi Kepulauan Riau (Lembaran Daerah Provinsi Kepulauan Riau Tahun 2016 Nomor 7, Tambahan Lembaran Daerah Provinsi Kepulauan Riau Nomor 41).</span></p>
            </td>
        </tr>
    </table>
    ...
    <table class="c39">
        <tr class="c75">
            ...
            <td class="c85" colspan="1" rowspan="1">
                <p class="c80"><span class="c1">{{$permohonan->formulir['Menimbang']}}</span></p>
            </td>
        </tr>
    </table>
    ...
    <table class="c40">
        ...
        <tr class="c64">
            ...
            <td class="c4" colspan="1" rowspan="1">
                <p class="c35"><span class="c1">Melakukan penelitian dengan judul </span><span class="c57">&ldquo;</span><span class="c1">{{$permohonan->formulir['Judul Penelitian']}}</span><span class="c57">&rdquo;</span></p>
            </td>
        </tr>
        <tr class="c73">
            <td class="c20" colspan="1" rowspan="1">
            ...
            <td class="c4" colspan="1" rowspan="1">
                <p class="c8"><span class="c1">{{$permohonan->formulir['Lokasi Penelitian']}}</span></p>
            </td>
        </tr>
        <tr class="c66">
            <td class="c20" colspan="1" rowspan="1">
    ...
    <table class="c74">
        ...
        <tr class="c62">
            <td class="c38" colspan="1" rowspan="1">
                ...
                <p class="c28"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 42.07px; height: 42.07px;">@if($permohonan ->status_permohonan_id == 12)<img alt="" src="images/image2.jpg" style="width: 42.07px; height: 42.07px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title="">@endif</span></p>
                <p class="c28 c47"><span class="c1"></span></p>
            </td>
        </tr>
        <tr class="c22">
